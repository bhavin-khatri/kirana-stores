...
const PhotoPicker = ({
  ...
  const PERMISSION_STRINGS = {
    AGENT_APP_CAMERA_ENABLE_PERMISSION_SETTINGS:
      'Permission denied, please allow camera access from your device settings to use this feature',
    AGENT_APP_GALLERY_ENABLE_PERMISSION_SETTINGS:
      'Permission denied, please allow storage access from your device settings to use this feature',
  };
          ...
          PermissionUtils.checkPermission({
            ...
            permissionName:
              Platform.OS === 'ios'
                ...
                : PERMISSIONS.ANDROID.CAMERA,
            message:
              PERMISSION_STRINGS.AGENT_APP_CAMERA_ENABLE_PERMISSION_SETTINGS,
          ...
          PermissionUtils.checkPermission({
            ...
            permissionName:
              Platform.OS === 'ios'
                ...
                : PERMISSIONS.ANDROID.CAMERA,
            message:
              PERMISSION_STRINGS.AGENT_APP_GALLERY_ENABLE_PERMISSION_SETTINGS,
            onSuccess: (onSuccess2: boolean) => {
              if (onSuccess2) {
